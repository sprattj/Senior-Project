...
export default class InventoryDisplayRig extends React.Component {
    constructor(props) {
        ...
        this.state = {
            ...
            manufacturer: this.props.manufacturer, // initially is manufacturer that's passed
            ...
            // values returned from 'rig_component_details' View in DB
            main_canopy_brand: this.props.main_canopy_brand,
            reserve_canopy_brand: this.props.reserve_canopy_brand
        };
...
/*         this.manufacturer = this.props.manufacturer;
    ...
    manufacturerChanged(e) 
    {
      ...
      main_canopy_brandChanged(e)
      {
        console.log("in main_canopy_brandChanged:  " + e.target.value);

        this.setState({
            main_canopy_brand: e.target.value
        });

        console.log("new main_canopy_brand value:  " + this.state.main_canopy_brand);       
      }

      reserve_canopy_brandChanged(e)
      {
        console.log("in reserve_canopy_brandChanged:  " + e.target.value);

        this.setState({
            reserve_canopy_brand: e.target.value
        });

        console.log("new reserve_canopy_brand value:  " + this.state.reserve_canopy_brand);       
      }
                                    ...
                                    <Row>
                                        ...
                                        <Col>
                                            <div>
                                                ...
                                                <InputGroup>
                                                    ...
                                                    <UncontrolledTextInput
                                                        onBlur          = {this.reserve_canopy_brandChanged}
                                                        id              = "item_typeID"
                                                        defaultText     = {this.props.reserve_canopy_brand}
                                                    />
                                                </InputGroup>
                                        ...
                                        <Col>
                                            <div>
                                                ...
                                                <br />
                                                <InputGroup>
                                                    <InputGroupAddon >Main Canopy: </InputGroupAddon>
                                                    <UncontrolledTextInput
                                                        onBlur          = {this.main_canopy_brandChanged}
                                                        id              = "main_canopy_brandID"
                                                        defaultText     = {this.props.main_canopy_brand}
                                                    />
                                                </InputGroup>
